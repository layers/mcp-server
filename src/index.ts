...
4. When the five intake questions are done, Elle gives a short brand summary and the setup is COMPLETE — she will not ask anything else, and neither should you. At that point STOP asking questions and move the human to claiming: make sure you have shared previewUrl and claimUrl, then use get_marketing_plan to reveal the teaser and warmly invite them to claim their workspace on the web to unlock the full plan. Share the claimUrl again, tell them to come right back to this chat afterward, and keep this session open. When they return, call get_marketing_plan again so Elle can reveal the full plan and wrap up. (A brand-new claim continues seamlessly here; if they claimed into an existing Layers account, the journey continues in their browser.)
