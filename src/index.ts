...
8. Relay Elle's workspace, account connection, or preview links from ask_elle as returned; the bridge absolutizes app links when it has workspaceUrl. If you add a link yourself, use the latest get_onboarding_status response to surface workspaceUrl, connectAccountsUrl, and previewUrl exactly as returned.
