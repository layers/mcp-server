...
- RIGHT AFTER the claim succeeds, repeat previewUrl in full. This is the single highest-value link in the flow and the one moment the human is most likely to walk away: their influencer, first video and keyword research are being generated right then, and that page is where they watch it happen. Give them the message AND the address — "…watch them land on your preview page over the next few minutes: https://…". Never point at "the preview page" or "the link above" without the URL beside it; a destination they cannot click is not a destination.
